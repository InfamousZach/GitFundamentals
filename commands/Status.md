...
It's a command that is safe to use at any time. If you want to see waht is going on it's good to use `git status` inbetween commands until you get to know the flow better.
